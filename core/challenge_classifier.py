...
CATEGORY_KEYWORDS: dict[str, list[str]] = {
    "web": [
        "http", "https", "url", "login", "register", "cookie", "session",
        "sql", "database", "query", "injection", "xss", "csrf", "ssrf",
        "jwt", "oauth", "graphql", "api", "rest", "endpoint", "web server",
        "php", "flask", "django", "express", "nginx", "apache",
        "admin panel", "upload", "file upload", "path traversal",
    ],
    "pwn": [
        "binary", "executable", "elf", "overflow", "buffer", "stack",
        "heap", "rop", "gadget", "shellcode", "pwn", "exploit", "gdb",
        "pwntools", "checksec", "nx", "pie", "aslr", "canary",
        "format string", "printf", "uaf", "use after free", "libc",
        "nc ", "netcat", "port", "remote", "service",
    ],
    "crypto": [
        "rsa", "aes", "des", "ecc", "elliptic", "prime", "modulus",
        "exponent", "cipher", "encrypt", "decrypt", "hash", "sha", "md5",
        "xor", "key", "iv", "nonce", "padding", "oracle", "lfsr",
        "diffie", "hellman", "discrete log", "lattice", "lll",
        "crypto", "cryptographic", "message", "ciphertext",
    ],
    "forensics": [
        "pcap", "wireshark", "network", "capture", "traffic",
        "memory", "dump", "volatility", "memdump", "process",
        "file", "recover", "deleted", "disk", "image", "forensic",
        "log", "artifact", "registry", "windows", "linux",
    ],
    "rev": [
        "reverse", "binary", "disassemble", "decompile", "asm", "assembly",
        "ida", "ghidra", "radare", "objdump", "strings", "stripped",
        "obfuscate", "pack", "upx", "vm", "virtual machine", "bytecode",
        "keygen", "serial", "license", "crack",
    ],
    "osint": [
        "osint", "reconnaissance", "recon", "domain", "whois", "dns",
        "social media", "twitter", "instagram", "facebook", "linkedin",
        "person", "identity", "location", "geolocation", "image",
        "reverse image", "metadata", "exif", "satellite",
    ],
    "steg": [
        "steganography", "hidden", "image", "png", "jpg", "jpeg", "bmp",
        "audio", "wav", "mp3", "lsb", "pixel", "spectral", "spectrogram",
        "invisible", "secret", "conceal",
    ],
}
